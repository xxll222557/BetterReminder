        ...
        <div className="flex-1 relative">
          <textarea
            ...
            className={`w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-800 
              dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-theme duration-theme ease-theme 
              hover:border-blue-400 min-h-[48px] max-h-[300px] resize-none overflow-hidden
              text-gray-700 leading-relaxed ${isLangMenuOpen ? 'placeholder-fade-out' : 'placeholder-fade-in'}`}
            disabled={isLoading}
            rows={1}
