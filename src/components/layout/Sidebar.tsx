    ...
    <>
      ...
      {!isSidebarOpen && (
        <button
          ...
          className="fixed top-4 left-4 z-40 p-2 rounded-full bg-white dark:bg-gray-800 shadow-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
